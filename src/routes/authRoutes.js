...
router.post("/registrar", (req, res) => {
  ...
  if (password !== confirmPassword) {
    return res
      .status(400)
      .json({ status: "error", message: "Las contraseñas no coinciden." });
  }
      ...
      bcrypt.hash(password, 10, (err, hashedPassword) => {
        ...
        db.query(
          ...
          (err, results) => {
            ...
            db.query(
              "INSERT INTO perfil (user_id, name, email, phone, address, extNumber, colonia, zip, city, state) VALUES (?, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)",
              [userId],
              (err) => {
                if (err) {
